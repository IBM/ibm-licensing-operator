...
func GetLicensingRoute(instance *operatorv1alpha1.IBMLicenseService) *routev1.Route {
...
func GetLicensingIngress(instance *operatorv1alpha1.IBMLicenseService) *extensionsv1.Ingress {
	var (
