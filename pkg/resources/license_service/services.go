...
func getServiceSpec(instance *operatorv1alpha1.IBMLicenseService) corev1.ServiceSpec {
...
func GetLicensingServiceName(instance *operatorv1alpha1.IBMLicenseService) string {
	return GetResourceName(instance)
}

func GetLicensingService(instance *operatorv1alpha1.IBMLicenseService, isOpenShift bool) *corev1.Service {
