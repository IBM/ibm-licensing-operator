...
func GetResourceName(instance *operatorv1alpha1.IBMLicenseService) string {
	return LicensingResourceBase + "-" + instance.GetName()
}

func GetUploadURL(instance *operatorv1alpha1.IBMLicenseService) string {
	...
	return urlPrefix + GetResourceName(instance) + "." + instance.GetNamespace() + ".svc.cluster.local:" + licensingServicePort.String()
}

func LabelsForSelector(instance *operatorv1alpha1.IBMLicenseService) map[string]string {
	return map[string]string{"app": GetResourceName(instance), "component": LicensingComponentName, "licensing_cr": instance.GetName()}
}

func LabelsForMeta(instance *operatorv1alpha1.IBMLicenseService) map[string]string {
...
func LabelsForLicensingPod(instance *operatorv1alpha1.IBMLicenseService) map[string]string {
