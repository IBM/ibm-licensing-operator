...
func GetAPISecretToken(instance *operatorv1alpha1.IBMLicenseService) (*corev1.Secret, error) {
...
func GetUploadToken(instance *operatorv1alpha1.IBMLicenseService) (*corev1.Secret, error) {
	return res.GetSecretToken(APIUploadTokenName, instance.GetNamespace(), APIUploadTokenKeyName, LabelsForMeta(instance))
}

func GetUploadConfigMap(instance *operatorv1alpha1.IBMLicenseService) *corev1.ConfigMap {
