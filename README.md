...
ibm-licensing-operator.v1.2.1   IBM Licensing Operator   1.2.1     ibm-licensing-operator.v1.2.1   Succeeded
```
...
```bash
export operator_release_version=v1.2.1-durham
