...
// IBMLicensingQuerySource is a custom resource for internal use only. It holds information about prometheus query used for license usage calculations.
// It is used by some IBM products to assign their pods to the licensed products for the licensing specific calculation, performed by the IBM License Service.
