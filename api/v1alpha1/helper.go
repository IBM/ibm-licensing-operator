...
var ephemeralStorage270Mi = resource.NewQuantity(270*1024*1024, resource.BinarySI) // 250Mi for logs + 20Mi (ConfigMaps + Secrets + emptyDir)
...
func (spec *IBMLicensingSpec) FillDefaultValues(reqLogger logr.Logger, isOCP4CertManager bool, isRouteEnabled bool, rhmpEnabled bool,
	...
	spec.Container.setResourceRequestEphemeralStorageIfNotSet(*ephemeralStorage270Mi)
