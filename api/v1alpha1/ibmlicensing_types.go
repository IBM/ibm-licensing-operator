...
type IBMLicensingStatus struct {
	...
	// +operator-sdk:csv:customresourcedefinitions:type=status,displayName="IBM License Service Status",xDescriptors="urn:alm:descriptor:urn:alm:descriptor:com.tectonic.ui:podStatuses"
