...
* For online environments, to upgrade to License Service version 1.4.x from an earlier version, you must manually update the distribution channel. For more information, see [Upgrading to License Service version 1.4.x from an earlier version](Upgrading_to_14x.md).
